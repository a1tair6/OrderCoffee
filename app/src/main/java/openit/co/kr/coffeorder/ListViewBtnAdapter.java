...
public class ListViewBtnAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 아이템 내 각 위젯에 데이터 반영
        editText.setText(listViewItem.getEditTextStr());
        textView.setText(listViewItem.getTextStr());

        // button1 클릭 시 TextView(textView1)의 내용 변경.
        Button button1 = (Button) convertView.findViewById(R.id.buttonUp);
        ...
        Button button2 = (Button) convertView.findViewById(R.id.buttonDown);
